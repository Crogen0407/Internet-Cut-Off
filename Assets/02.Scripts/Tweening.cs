...
namespace UnityEngine.Tweening
{
    ...
    public class  Tweening : MonoSingleton<Tweening>
    {
        ...
        public void DOMove(Rigidbody2D rigidbody, Vector3 endPoint, float duration, EasingType easing)
        {
            StartCoroutine(Move(rigidbody, endPoint, duration, easing));
        }
        ...
        private IEnumerator Move(Rigidbody2D rigidbody, Vector3 endPoint, float duration, EasingType easing)
        {
            float currentTime = 0;
            float percentTime = 0;
